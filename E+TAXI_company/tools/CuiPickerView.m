...
@interface CuiPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
{
    NSInteger yearRange;
    NSInteger dayRange;
    NSInteger startYear;
...
- (id)init {
    if (self = [super init]) {
       ...
       // self.pickerView=[[UIPickerView alloc]initWithFrame:CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 180)];
        ...
        [cancelButton setTitleColor:RGBColor(153, 153, 153) forState:UIControlStateNormal];
        ...
        [chooseButton setTitleColor:RGBColor(75, 187, 245) forState:UIControlStateNormal];
